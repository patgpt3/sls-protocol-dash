...
import MDPaginationItemRoot from 'components/Elements/MDPagination/MDPaginationItemRoot';
...
const MDPagination: FC<Props | any> = forwardRef<HTMLButtonElement, Props>(
