...
import MDSocialButtonRoot from 'components/Elements/MDSocialButton/MDSocialButtonRoot';
...
const MDSocialButton = forwardRef<HTMLButtonElement, Props>(
  ({ color, size, iconOnly, circular, children, ...rest }, ref) => (
    <MDSocialButtonRoot
      ...
      color="primary"
      size={size}
      ownerState={{ color: color || 'primary', size, iconOnly, circular }}
    >
      {children}
    </MDSocialButtonRoot>
  )
