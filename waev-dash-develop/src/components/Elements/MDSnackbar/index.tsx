...
import MDSnackbarIconRoot from 'components/Elements/MDSnackbar/MDSnackbarIconRoot';
      ...
      >
        ...
        >
          <MDBox display="flex" alignItems="center" lineHeight={0}>
            <MDSnackbarIconRoot fontSize="small" ownerState={{ color: color || 'primary', bgWhite }}>
              {icon}
            </MDSnackbarIconRoot>
            <MDTypography
              variant="button"
