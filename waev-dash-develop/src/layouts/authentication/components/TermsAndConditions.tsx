...
// Temporary template for Terms and Conditions.

// export const TermsAndConditions = () => {
//   return (
//     <MDBox pt={3} pb={1} px={1} textAlign="left">
...
//         our website, Website Name accessible at Website.com. These Terms will be applied fully and
//         affect to your use of this Website. By using this Website, you agreed to accept all terms
//         and conditions written in here. You must not use this Website if you disagree with any of
//         these Website Standard Terms and Conditions. Minors or people below 18 years old are not
