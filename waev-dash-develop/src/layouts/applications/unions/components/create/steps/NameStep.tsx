...
export function NameStep({ setUnionNameInput, unionNameInput }: Props): JSX.Element {
  return (
    <MDBox>
      <MDBox width="82%" textAlign="center" mx="auto" my={4}>
        ...
        <MDTypography variant="body2" color="text">
          What's the name of the Data Union?
        </MDTypography>
      </MDBox>
      <MDBox mt={2}>
          ...
          <Grid item xs={12} sm={8}>
            <MDBox mb={2}>
              <FormField
                ...
                onChange={(e: InputEvent) => setUnionNameInput(e.target.value)}
              />
            </MDBox>
          </Grid>
        </Grid>
