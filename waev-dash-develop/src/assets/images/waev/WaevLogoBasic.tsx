...
export const WaevLogoBasic = ({ width = '220', height = '60' }: Props): JSX.Element => {
  // Render SLS logo (shield + DB lock) with SLS wordmark
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 480 120">
      <g fill="none" fillRule="evenodd">
        ...
        />
        {/* DB cylinder */}
        <ellipse cx="68" cy="44" rx="30" ry="12" fill="#0B1A2A" stroke="#FFFFFF" strokeWidth="6" />
        <rect x="38" y="44" width="60" height="34" rx="6" fill="#0B1A2A" stroke="#FFFFFF" strokeWidth="6" />
        <ellipse cx="68" cy="78" rx="30" ry="12" fill="#0B1A2A" stroke="#FFFFFF" strokeWidth="6" />
        {/* Lock */}
